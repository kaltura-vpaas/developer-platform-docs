...
3. The structure and field names should respect that of the [Kaltura Bulk Upload XML Schema](/api-docs/XML_Schemas/Bulk_Upload).
...
1. After you create the CSV or XML file that you want to submit for ingestion, call the [media.bulkUploadAdd action](/api-docs/Execute_Bulk_Ingest_and_Updates/media_bulkUploadAdd) to execute the ingestion job.   
2. Once submitted, you can use the [bulk service](/api-docs/Execute_Bulk_Ingest_and_Updates/bulk) to review the status of your ingestion job or to cancel it.   
